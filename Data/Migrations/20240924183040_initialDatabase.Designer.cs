...
namespace Data.Migrations
{
    ...
    [Migration("20240924183040_initialDatabase")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Data.Entities.CustomerService.Abnormal.OrderAbnormal", b =>
                {
                    b.Property<string>("OrderId")
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("AbnormalId")
                        .HasColumnType("nvarchar(450)");

                    b.HasKey("OrderId", "AbnormalId");

                    b.HasIndex("AbnormalId");

                    b.ToTable("OrderAbnormals");
                });

            modelBuilder.Entity("Data.Entities.CustomerService.Ticket.OrderTicket", b =>
                {
                    b.Property<string>("OrderId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Data.Entities.Finance.Client_Quotation", b =>
                {
                    ...
                    b.HasKey("ClientCode", "QuotationId");

                    b.HasIndex("QuotationId");

                    b.ToTable("Client_Quotations");
                });
            ...
            modelBuilder.Entity("Data.Entities.Operation.COD_FOD_Adjustment.Order_COD_FOD_App", b =>
                {
                    ...
                    b.HasKey("OrderNumber", "ApplicationId");

                    b.HasIndex("ApplicationId");

                    b.ToTable("Order_COD_FOD_Apps");
                });
            ...
            modelBuilder.Entity("Data.Entities.Operation.Sorting.FirstSegment", b =>
                {
                    b.Property<int>("BaggingNumber")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("BaggingNumber"), 1L, 1);

                    b.Property<string>("AreaId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("BaggingName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Data.Entities.Operation.Sorting.SecondSegment", b =>
                {
                    ...
                    b.Property<string>("SecendSegmentCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Data.Entities.Operation.COD_FOD_Adjustment.Order_COD_FOD_App", b =>
                {
                    b.HasOne("Data.Entities.Operation.COD_FOD_Adjustment.COD_FOD_Application", "Application")
                        .WithMany("Order_COD_FOD_Apps")
            ...
            modelBuilder.Entity("Data.Entities.Operation.Sorting.SecondSegment", b =>
                {
                    ...
                    b.HasOne("Data.Entities.Operation.Sorting.FirstSegment", "FirstSegment")
                        .WithMany()
                        .HasForeignKey("FirstSegmentCode")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Data.Entities.Finance.Quotation", b =>
                {
                    b.Navigation("Client_Quotations");
            ...
            modelBuilder.Entity("Data.Entities.Operation.COD_FOD_Adjustment.COD_FOD_Application", b =>
                {
                    b.Navigation("Order_COD_FOD_Apps");
                });
